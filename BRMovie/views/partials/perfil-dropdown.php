		...
		<div class="row row-perfil">
			<div class="col col-lg-1 profile">
				...
				<div class="dropdown-content" id="dropId">
					<a href="?action=perfil" style="text-decoration: none; color: #000000;">
						<p class="p-filmes" style="padding: 1vh;">Perfil</p>
					</a>
					<a href="?action=logout" style="text-decoration: none; color: #f72020;">
						<p class="p-filmes" style="padding: 1vh; color: #f72020;">Sair</p>
					</a>
				</div>
			</div>
		</div>
