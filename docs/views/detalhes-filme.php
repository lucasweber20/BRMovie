...
<html style="overflow-y: auto;">
	...
	<body>
		<div class="col" style="max-width: 13vw; margin-left: 25vw; margin-bottom: -5vh; margin-top: 2vh;">
			<h1 style="white-space: nowrap;"><?= $recuperaVideo[0]['nome'];?></h1>
		</div>
		<div class="col" style="margin-left: 15vw;">
			<iframe class="player" src="<?= $recuperaVideo[0]['linkVideo'];?>" allowfullscreen=true></iframe>
		</div><br>
